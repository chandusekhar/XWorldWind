//
// LogoURLType.SetSamplerState(0, SamplerStatecs.SetSamplerState(0, SamplerStatecs
//
...
{
	public class LogoURLType : Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode
	{
		#region Forward constructors
		public LogoURLType() : base() {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public LogoURLType(XmlDocument doc) : base(doc) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public LogoURLType(XmlNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public LogoURLType(Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		...
		{
			return new SchemaLong(GetDomNodeValue(this.SetSamplerState(0, SamplerStateGetDomChildAt(NodeType.SetSamplerState(0, SamplerStateAttribute, "", "width", index)));
		}
		...
		{
			return new SchemaLong(GetDomNodeValue(this.SetSamplerState(0, SamplerStateGetDomChildAt(NodeType.SetSamplerState(0, SamplerStateAttribute, "", "height", index)));
		}
