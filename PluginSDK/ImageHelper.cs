...
namespace WorldWind
{
	...
	public sealed class ImageHelper
	{
		...
		public static Texture LoadTexture(string textureFileName, int colorKey, Format textureFormat)
		{
			...
			{
				throw new SharpDX.Direct3D9.InvalidDataException(string.Format("Error reading image file '{0}'.", textureFileName));
			}
		}
		...
		public static Texture LoadTexture(Stream textureStream, int colorKey, Format textureFormat)
		{
			...
			catch (SharpDX.Direct3D9.InvalidDataException)
			{
			}
			...
			{
				throw new SharpDX.Direct3D9.InvalidDataException("Error reading image stream.");
			}
		}
