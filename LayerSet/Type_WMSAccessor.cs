...
namespace LayerSet
{
	public class Type_WMSAccessor : Altova.Xml.Node
	{
		...
		public Type_WMSAccessor() : base() {
            this.SetCollectionParents(); }
		public Type_WMSAccessor(XmlDocument doc) : base(doc) {
            this.SetCollectionParents(); }
		public Type_WMSAccessor(XmlNode node) : base(node) {
            this.SetCollectionParents(); }
		public Type_WMSAccessor(Altova.Xml.Node node) : base(node) {
            this.SetCollectionParents(); }
		...
		{
			return new BoundingBoxOverlapType(GetDomNodeValue(this.GetDomChildAt(NodeType.Element, "", "BoundingBoxOverlap", index)));
		}
