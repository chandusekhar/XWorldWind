//
// Type_DisplayFont.SetSamplerState(0, SamplerStatecs.SetSamplerState(0, SamplerStatecs
//
...
namespace LayerSet
{
	public class Type_DisplayFont : Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode
	{
		#region Forward constructors
		public Type_DisplayFont() : base() {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_DisplayFont(XmlDocument doc) : base(doc) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_DisplayFont(XmlNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_DisplayFont(Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
