//
// Type_ImageTileService.SetSamplerState(0, SamplerStatecs.SetSamplerState(0, SamplerStatecs
//
...
namespace LayerSet
{
	public class Type_ImageTileService : Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode
	{
		#region Forward constructors
		public Type_ImageTileService() : base() {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_ImageTileService(XmlDocument doc) : base(doc) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_ImageTileService(XmlNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_ImageTileService(Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
