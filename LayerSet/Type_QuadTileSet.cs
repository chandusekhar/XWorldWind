//
// Type_QuadTileSet.SetSamplerState(0, SamplerStatecs.SetSamplerState(0, SamplerStatecs
//
...
namespace LayerSet
{
	public class Type_QuadTileSet : Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode
	{
		#region Forward constructors
		public Type_QuadTileSet() : base() {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_QuadTileSet(XmlDocument doc) : base(doc) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_QuadTileSet(XmlNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_QuadTileSet(Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
