//
// Type_LongitudeCoordinate2.SetSamplerState(0, SamplerStatecs.SetSamplerState(0, SamplerStatecs
//
...
namespace LayerSet
{
	public class Type_LongitudeCoordinate2 : Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode
	{
		#region Forward constructors
		public Type_LongitudeCoordinate2() : base() {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_LongitudeCoordinate2(XmlDocument doc) : base(doc) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_LongitudeCoordinate2(XmlNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_LongitudeCoordinate2(Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		...
		{
			return new ValueType4(GetDomNodeValue(this.SetSamplerState(0, SamplerStateGetDomChildAt(NodeType.SetSamplerState(0, SamplerStateElement, "", "Value", index)));
		}
		...
		public ValueType4 GetValue2ValueAtCursor( XmlNode curNode )
		{
			if( curNode == null )
				...
				return new ValueType4( curNode.SetSamplerState(0, SamplerStateInnerText );
		}
