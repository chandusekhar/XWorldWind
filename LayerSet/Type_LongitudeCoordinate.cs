//
// Type_LongitudeCoordinate.SetSamplerState(0, SamplerStatecs.SetSamplerState(0, SamplerStatecs
//
...
namespace LayerSet
{
	public class Type_LongitudeCoordinate : Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode
	{
		#region Forward constructors
		public Type_LongitudeCoordinate() : base() {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_LongitudeCoordinate(XmlDocument doc) : base(doc) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_LongitudeCoordinate(XmlNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public Type_LongitudeCoordinate(Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		...
		{
			return new ValueType2(GetDomNodeValue(this.SetSamplerState(0, SamplerStateGetDomChildAt(NodeType.SetSamplerState(0, SamplerStateElement, "", "Value", index)));
		}
		...
		public ValueType2 GetValue2ValueAtCursor( XmlNode curNode )
		{
			if( curNode == null )
				...
				return new ValueType2( curNode.SetSamplerState(0, SamplerStateInnerText );
		}
