...
namespace onlyconnect
{
    ...
    public class HtmlEditor : Control
    {
        ...
        private bool bLoadDocumentWhenReady;
        private bool bLoadUrlWhenReady;
        private bool bSetComposeSettingsWhenReady;
        private int iLoadAttempts;
        ...
        private bool mIsWin98;
        private bool mAlwaysLoadAnsi;
        internal bool mLinksNewWindow;
        internal bool bNeedsActivation;
        internal bool mAcceptsTab;
        internal bool mAcceptsReturn = true;
        internal DocHTML mDocHTML;

        internal HtmlSite site;
        String url = String.Empty;
        String sDocument = String.Empty;
        internal bool mDesignMode;
        private bool mIsContextMenuEnabled = true;
        private string mOptionKeyPath;
        ...
        private HandleWndProc mNativeDocWindow;
        private Timer activateTimer;
        private Timer createTimer;
        private IContainer components;
        private ComposeSettings mComposeSettings;

        internal bool mEnableActiveContent = true;
        internal bool mEnableAutoComplete;
        internal bool mDivOnEnter;
        internal bool mShowScrollBars = true;
        internal bool mEnableUrlDetection;
            ...
            : base()
        {
            ...
            this.mIsWin98 = (Environment.OSVersion.Platform == PlatformID.Win32Windows);
            ...
            switch (m.Msg)
            {
                case win32.WM_KEYDOWN:
                    ...
                    if (!isHandled)
                    {
                        ...
                        isHandled = this.site.CallTranslateAccelerator(msg);
                    }
                ...
                case win32.WM_MOUSEACTIVATE:
                    {
                        ...
                        if (this.site != null)
                        {
                            ...
                            if (!this.DesignMode)
                            {
                                ...
                                this.mDocumentHandle = this.site.DocumentHandle;
        ...
        void initMshtml()
        {
            ...
            {
                IntPtr hostHandle = this.Handle;
            }

            this.site = new HtmlSite(this);

            this.site.CreateDocument();

            if (this.Visible)
            {
                this.site.ActivateDocument();
            }
            else
            {
            ...
            this.mHtmlDoc = (HTMLDocument) this.site.Document;
            this.mDocHTML = new DocHTML(this.mHtmlDoc);
            ...
            this.site.SetPropertyNotifyEvents();
            ...
            if (this.sDocument != String.Empty)
            {
                this.LoadDocument(this.sDocument);
            }
            else
            {
                if (this.mDesignMode)
        ...
        private void InitializeComponent()
        {
            ...
            this.activateTimer = new Timer(this.components);
            this.createTimer = new Timer(this.components);
            this.SuspendLayout();
            // 
            // activateTimer
            // 
            ...
            this.createTimer.Tick += new EventHandler(this.createTimer_Tick);
        ...
        {
            if (this.HtmlEvent != null)
            {
                // Get the event.
                IHTMLEventObj pobjEvent = ((IHTMLDocument2) this.mHtmlDoc).GetParentWindow().eventobj;
                HtmlEventArgs ea = new HtmlEventArgs(pobjEvent);
                this.HtmlEvent(this, ea);
            }
            return;
        }
        ...
        public void InvokeNavigate(String target)
        {
            ...
            if (this.Navigate != null) this.Navigate(this, new HtmlNavigateEventArgs(target));
        }
        ...
        protected virtual void OnBeforeShortcut(BeforeShortcutEventArgs e)
        {
            if (this.BeforeShortcut != null) this.BeforeShortcut(this, e);
        }
        ...
        /// </summary>
        /// <param name="e">Cancellable event args</param>
        protected internal virtual void OnBeforeNavigate(BeforeNavigateEventArgs e)
        {
            if (this.BeforeNavigate != null) this.BeforeNavigate(this, e);
        }
        ...
        {
            if (this.BeforePaste != null) this.BeforePaste(this, e);
        }
        ...
        private void setChangeNotify()
        {
            ...
            hr = ((IMarkupContainer2)this.HtmlDocument2).RegisterForDirtyRange(this.mChangeMonitor, out this.changeCookie);
        }
        ...
        public void SetEditDesigner()
        {
            IHTMLDocument2 htmldoc = (IHTMLDocument2)this.mHtmlDoc;
            htmldoc.SetDesignMode("On");
            IServiceProvider isp = (IServiceProvider) this.mHtmlDoc;
            IHTMLEditServices es;
            Guid IHtmlEditServicesGuid = new Guid("3050f663-98b5-11cf-bb82-00aa00bdce0b");
            Guid SHtmlEditServicesGuid = new Guid(0x3050f7f9, 0x98b5, 0x11cf, 0xbb, 0x82, 0x00, 0xaa, 0x00, 0xbd, 0xce, 0x0b);
            IntPtr ppv;
            IHTMLEditDesigner ds = (IHTMLEditDesigner) this.site;
            if (isp != null)
            {
        ...
        void SetHTMLEvents()
        {
            if ((this.mHtmlDoc != null) && (this.HtmlEvent != null))
            {
        ...
        public ComposeSettings DefaultComposeSettings
        {
            get
            {
                ...
                {
                    this.mComposeSettings = new ComposeSettings(this);
                }

                return this.mComposeSettings;
            }
        }
        ...
        {
            get { return this.mDocumentEncoding; }
            set { this.mDocumentEncoding = value; }
        }
        ...
        {
            get { return this.mDefaultPreamble; }
            set { this.mDefaultPreamble = value; }
        }
        ...
        public bool IsContextMenuEnabled
        {
            ...
            set
            {
                this.mIsContextMenuEnabled = value;
            }
        }
        ...
        public bool IsActivationEnabled
        {
            get
            {
                return this.mAllowActivation;
            }
            set
            {
                this.mAllowActivation = value;
            }
        }
        ...
        public bool IsActiveContentEnabled
        {
            ...
            get
            {
                return this.mEnableActiveContent;
            }

            set
            {
                this.mEnableActiveContent = value;
            }
        }
        ...
        public bool IsAutoCompleteEnabled
        {
            ...
            get
            {
                return this.mEnableAutoComplete;
            }

            set
            {
                this.mEnableAutoComplete = value;
            }
        }
        ...
        public bool IsDivOnEnter
        {
            ...
            get
            {
                return this.mDivOnEnter;
            }

            set
            {
                this.mDivOnEnter = value;
            }
        }
        ...
        public HTMLDocument Document
        {
            get
            {
                ...
                if (this.site.Document != null)
                {
                    return (HTMLDocument) this.site.Document;
                }
                else
                {
                    return null;
        ...
        public IHTMLDocument2 HtmlDocument2
        {
            get
            {
                ...
                if (this.site.Document != null)
                {
                    return (IHTMLDocument2) this.site.Document;
                }
                else
                {
                    return null;
        ...
        public string ReadyState
        {
            get
            {
                ...
                return this.HtmlDocument2.GetReadyState().ToLower();
            }
        }
        ...
        {
            get { return this.mLinksNewWindow; }
            set
            {
                this.mLinksNewWindow = value;
            }
        }
        ...
        public Color SelectionBackColor
        {
            get
            {
                if (this.Document == null) return Color.Empty;
                else
                {
                    object Result = this.HtmlDocument2.QueryCommandValue("ForeColor");
                    try
                    {
        ...
        public Font SelectionFont
        {
            get
            {
                try
                {
                    ...
                    if (Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("bold"))) fs |= FontStyle.Bold;
                    if (Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("italic"))) fs |= FontStyle.Italic;
                    if (Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("underline"))) fs |= FontStyle.Underline;

                    switch (Convert.ToInt32(this.HtmlDocument2.QueryCommandValue("FontSize")))
                    {
                        case 1:
                            FontSize = 8;
                            break;
                    ...
                    string FontName = this.HtmlDocument2.QueryCommandValue("FontName").ToString();
            ...
            set
            {
                try
                { //This is here because of hosting issues on a UserControl
                    if ((this.Document == null) | (value == null)) return;

                    this.HtmlDocument2.ExecCommand("FontName", false, value.Name);

                    if (value.SizeInPoints <= 8)
                    {
                        this.HtmlDocument2.ExecCommand("FontSize", false, 1);
                    }
                    else if (value.SizeInPoints <= 10)
                    {
                        this.HtmlDocument2.ExecCommand("FontSize", false, 2);
                    }
                    else if (value.SizeInPoints <= 12)
                    {
                        this.HtmlDocument2.ExecCommand("FontSize", false, 3);
                    }
                    else if (value.SizeInPoints <= 18)
                    {
                        this.HtmlDocument2.ExecCommand("FontSize", false, 4);
                    }
                    else if (value.SizeInPoints <= 24)
                    {
                        this.HtmlDocument2.ExecCommand("FontSize", false, 5);
                    }
                    else if (value.SizeInPoints <= 36)
                    {
                        this.HtmlDocument2.ExecCommand("FontSize", false, 6);
                    }
                    else
                    {
                        this.HtmlDocument2.ExecCommand("FontSize", false, 7);
                    }

                    if (Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("bold")) != this.Font.Bold) this.HtmlDocument2.ExecCommand("bold", false, null);
                    if (Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("italic")) != this.Font.Bold) this.HtmlDocument2.ExecCommand("italic", false, null);
                    if (Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("underline")) != this.Font.Bold) this.HtmlDocument2.ExecCommand("underline", false, null);
                }
                catch { }
            }
        }
        ...
        public HorizontalAlignment SelectionAlignment
        {
            get
            {
                if (this.Document == null) return HorizontalAlignment.Left;
                else
                {
                    if (Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("JustifyRight")))
                    {
                        return HorizontalAlignment.Right;
                    }
                    else if (Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("JustifyCenter")))
                    {
            ...
            set
            {
                ...
                switch (value)
                {
                    case HorizontalAlignment.Left:
                        this.HtmlDocument2.ExecCommand("JustifyLeft", false, null);
                        break;
                    case HorizontalAlignment.Center:
                        this.HtmlDocument2.ExecCommand("JustifyCenter", false, null);
                        break;
                    case HorizontalAlignment.Right:
                        this.HtmlDocument2.ExecCommand("JustifyRight", false, null);
                        break;
                }
            }
        }
        ...
        public bool SelectionNumbering
        {
            get
            {
                ...
                else return Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("InsertOrderedList"));
            }
            set
            {
                if (this.Document != null && Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("InsertOrderedList")) != value) this.HtmlDocument2.ExecCommand("InsertOrderedList", false, null);
            }
        }
        ...
        public bool SelectionBullets
        {
            ...
            {
                if (this.Document == null) return false;
                else return Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("InsertUnorderedList"));
            }
            set
            {
                if (this.Document != null && Convert.ToBoolean(this.HtmlDocument2.QueryCommandValue("InsertUnorderedList")) != value) this.HtmlDocument2.ExecCommand("InsertUnorderedList", false, null);
            }
        }
        ...
        public void LoadDocument(String documentVal)
        {
            ...
            this.site.mFullyActive = false;

            Encoding theDefaultPreamble = this.getEncodingFromEncodingType(this.mDefaultPreamble);

            utils.LoadDocument(ref this.mHtmlDoc, this.sDocument, this.mAlwaysLoadAnsi, false, theDefaultPreamble);
        ...
        public void LoadUrl(String url)
        {
            ...
            if (!this.isCreated)
            {
                Debug.WriteLine("Doc not created" + this.iLoadAttempts.ToString());
                if (this.iLoadAttempts < 2)
                {
            ...
            utils.LoadUrl(ref this.mHtmlDoc, url, false);
            this.iLoadAttempts = 0;
        }
        ...
        Boolean isCreated
        {
            get
            {
                return (this.site != null) && (this.site.Document != null);
            }
        }
        ...
        internal bool setDefaultFont()
        {
            ...
            object o = this.mComposeSettings.CommandString;
    ...
    class HandleWndProc : NativeWindow
    {
        ...
        protected override void WndProc(ref Message message)
        {
            ...
            else
            {
                ...
                switch (message.Msg)
                {
                    case win32.WM_LBUTTONDOWN:
                        this.thecontrol.InvokeOnMouseDown(new MouseEventArgs(MouseButtons.Left, 1, message.LParam.ToInt32() & 0xffff, Convert.ToInt32((message.LParam.ToInt32() & 0xffff0000) >> 16), 0));
                        break;
                    case win32.WM_RBUTTONDOWN:
                        this.thecontrol.InvokeOnMouseDown(new MouseEventArgs(MouseButtons.Right, 1, message.LParam.ToInt32() & 0xffff, Convert.ToInt32((message.LParam.ToInt32() & 0xffff0000) >> 16), 0));
                        break;
                    case win32.WM_LBUTTONDBLCLK:
                    case win32.WM_MBUTTONDBLCLK:
                    case win32.WM_RBUTTONDBLCLK:
                        this.thecontrol.InvokeOnDoubleClick();
                        break;
                }
            }
            ...
            if (bPassToControl)
            {
                this.thecontrol.InvokeWndProc(ref message);
            }
