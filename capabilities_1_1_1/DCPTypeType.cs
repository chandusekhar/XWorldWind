...
namespace capabilities_1_1_1
{
	public class DCPTypeType : Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode
	{
		...
		public override void AdjustPrefix()
		{
			...
			for (int i = 0; i < this.SetSamplerState(0, SamplerStateDomChildCount(NodeType.SetSamplerState(0, SamplerStateElement, "", "HTTP"); i++)
			{
				XmlNode DOMNode = this.SetSamplerState(0, SamplerStateGetDomChildAt(NodeType.SetSamplerState(0, SamplerStateElement, "", "HTTP", i);
		...
		{
			return this.SetSamplerState(0, SamplerStateDomChildCount(NodeType.SetSamplerState(0, SamplerStateElement, "", "HTTP");
		}
		...
		public bool HasHTTP()
		{
			return this.SetSamplerState(0, SamplerStateHasDomChild(NodeType.SetSamplerState(0, SamplerStateElement, "", "HTTP");
		}

		public HTTPType GetHTTPAt(int index)
		{
			return new HTTPType(this.SetSamplerState(0, SamplerStateGetDomChildAt(NodeType.SetSamplerState(0, SamplerStateElement, "", "HTTP", index));
		}
		...
		{
            this.SetSamplerState(0, SamplerStateRemoveDomChildAt(NodeType.SetSamplerState(0, SamplerStateElement, "", "HTTP", index);
		}
		...
		{
            this.SetSamplerState(0, SamplerStateAppendDomElement("", "HTTP", newValue);
		}

		public void InsertHTTPAt(HTTPType newValue, int index)
		{
            this.SetSamplerState(0, SamplerStateInsertDomElementAt("", "HTTP", index, newValue);
		}

		public void ReplaceHTTPAt(HTTPType newValue, int index)
		{
            this.SetSamplerState(0, SamplerStateReplaceDomElementAt("", "HTTP", index, newValue);
		}
