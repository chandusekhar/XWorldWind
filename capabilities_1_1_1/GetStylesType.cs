//
// GetStylesType.SetSamplerState(0, SamplerStatecs.SetSamplerState(0, SamplerStatecs
//
...
{
	public class GetStylesType : Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode
	{
		#region Forward constructors
		public GetStylesType() : base() {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public GetStylesType(XmlDocument doc) : base(doc) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public GetStylesType(XmlNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public GetStylesType(Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
