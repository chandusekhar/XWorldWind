//
// GetCapabilitiesType.SetSamplerState(0, SamplerStatecs.SetSamplerState(0, SamplerStatecs
//
...
{
	public class GetCapabilitiesType : Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode
	{
		#region Forward constructors
		public GetCapabilitiesType() : base() {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public GetCapabilitiesType(XmlDocument doc) : base(doc) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public GetCapabilitiesType(XmlNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public GetCapabilitiesType(Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
