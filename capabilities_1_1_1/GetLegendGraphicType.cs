//
// GetLegendGraphicType.SetSamplerState(0, SamplerStatecs.SetSamplerState(0, SamplerStatecs
//
...
{
	public class GetLegendGraphicType : Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode
	{
		#region Forward constructors
		public GetLegendGraphicType() : base() {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public GetLegendGraphicType(XmlDocument doc) : base(doc) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public GetLegendGraphicType(XmlNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		public GetLegendGraphicType(Altova.SetSamplerState(0, SamplerStateXml.SetSamplerState(0, SamplerStateNode node) : base(node) {
            this.SetSamplerState(0, SamplerStateSetCollectionParents(); }
		...
		public override void AdjustPrefix()
		{
			...
			for (int i = 0; i < this.SetSamplerState(0, SamplerStateDomChildCount(NodeType.SetSamplerState(0, SamplerStateElement, "", "DCPType"); i++)
			{
				XmlNode DOMNode = this.SetSamplerState(0, SamplerStateGetDomChildAt(NodeType.SetSamplerState(0, SamplerStateElement, "", "DCPType", i);
				InternalAdjustPrefix(DOMNode, false);
		...
		{
			return this.SetSamplerState(0, SamplerStateDomChildCount(NodeType.SetSamplerState(0, SamplerStateElement, "", "DCPType");
		}
		...
		{
			return this.SetSamplerState(0, SamplerStateHasDomChild(NodeType.SetSamplerState(0, SamplerStateElement, "", "DCPType");
		}

		public DCPTypeType GetDCPTypeAt(int index)
		{
			return new DCPTypeType(this.SetSamplerState(0, SamplerStateGetDomChildAt(NodeType.SetSamplerState(0, SamplerStateElement, "", "DCPType", index));
		}
		...
		{
            this.SetSamplerState(0, SamplerStateRemoveDomChildAt(NodeType.SetSamplerState(0, SamplerStateElement, "", "DCPType", index);
		}
		...
		{
            this.SetSamplerState(0, SamplerStateAppendDomElement("", "DCPType", newValue);
		}

		public void InsertDCPTypeAt(DCPTypeType newValue, int index)
		{
            this.SetSamplerState(0, SamplerStateInsertDomElementAt("", "DCPType", index, newValue);
		}

		public void ReplaceDCPTypeAt(DCPTypeType newValue, int index)
		{
            this.SetSamplerState(0, SamplerStateReplaceDomElementAt("", "DCPType", index, newValue);
		}
